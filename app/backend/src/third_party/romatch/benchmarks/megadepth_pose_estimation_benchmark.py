import numpy as np
import torch
from src.third_party.romatch.utils import *
from PIL import Image
from tqdm import tqdm
import torch.nn.functional as F
import src.third_party.romatch
        ...
        with torch.no_grad():
            ...
            for scene_ind in range(len(self.scenes)):
                ...
                for pairind in tqdm(pair_inds):
                    ...
                    w2, h2 = im_B.size
                    if True: # Note: we keep this true as it was used in DKM/tiny_RoMa papers. There is very little difference compared to setting to False.
